    ...
    return (
      ...
      <Animated.View style={{
        ...
        <View style={styles.filterGroup}>
          <TouchableHighlight onPress={() => handleFilter(SHOW_ALL)}   activeOpacity={0.3} underlayColor='#e0f2f1'><Text style={filter === SHOW_ALL ? styles.textActive : styles.text}>All</Text></TouchableHighlight>
