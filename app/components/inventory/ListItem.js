...
const styles = StyleSheet.create({
  ...
  editItemName: { borderColor: '#ddd', borderWidth: 1, width: 0.62*(width-20), paddingLeft: 3, paddingRight: 8 },
  editInputField: { width: (0.54*(width-20))-3, alignItems: 'center'  },
  editItemAmount: { width: (0.30*(width-20)) },
  editItemIcon: { width: 0.08*(width-20) }
})